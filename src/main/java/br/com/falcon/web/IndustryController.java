...
import br.com.falcon.repository.IndustryRepository;
import br.com.falcon.security.TokenUtils;
import br.com.falcon.web.response.IndustriesResponse;
...
public class IndustryController {
    ...
    public ResponseEntity<?> view(HttpServletRequest request, Device device) throws AuthenticationException {
        ...
        return new ResponseEntity<>(new IndustriesResponse(industryRepository.findByOrderById()), HttpStatus.OK);
    }
}